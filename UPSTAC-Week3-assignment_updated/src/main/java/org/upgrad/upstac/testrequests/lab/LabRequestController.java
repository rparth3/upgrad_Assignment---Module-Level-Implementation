...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
       ...
       User tester = new User();// created object of User class 
    	tester = userLoggedInService.getLoggedInUser(); // to get logged in user
    	return testRequestQueryService.findByTester(tester);  //to get all request assign to logged in user(here its tester) and return in form of list
